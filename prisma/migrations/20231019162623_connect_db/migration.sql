...
-- CreateEnum
CREATE TYPE "meetingEnumStatus" AS ENUM ('Active', 'Complete', 'Expired', 'Cancel');

-- CreateEnum
CREATE TYPE "PrescriptionEnumStatus" AS ENUM ('Pending', 'Assing', 'Complete');

-- CreateEnum
CREATE TYPE "appointmentStatus" AS ENUM ('Pending', 'Accepted', 'Complete', 'Expired', 'Reject', 'TestSebmit', 'Cancel');
...
-- CreateEnum
CREATE TYPE "DonorRequestStatus" AS ENUM ('Pending', 'Accepted', 'Completed', 'Cancel');

-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('User', 'BloodDonor', 'Doctor', 'Admin');

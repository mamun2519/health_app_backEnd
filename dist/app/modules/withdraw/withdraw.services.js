...
const doctorWithDrawRequest = (authUserId, data) =>
...
const withdrawAccepted = (authUserId, id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield prisma_1.default.$transaction(transactionClient =>
      __awaiter(void 0, void 0, void 0, function* () {
        ...
        const doctorTotalBalance =
          ...
          Number(doctor === null || doctor === void 0 ? void 0 : doctor.amount)
        ...
        const companyFinalBalance =
          ((_d = companyBalance[0]) === null || _d === void 0
            ? void 0
            : _d.balance) +
          Number(
            doctor === null || doctor === void 0 ? void 0 : doctor.companyEarn,
          )
        yield transactionClient.companyBalance.update({
          where: {
            id:
              (_e = companyBalance[0]) === null || _e === void 0
                ? void 0
                : _e.id,
          },
          data: {
        ...
        const message = `Accepted your withdraw request. withdraw balance ${
          doctor === null || doctor === void 0 ? void 0 : doctor.amount
        } BDT. 20% companyEarn ${
          doctor === null || doctor === void 0 ? void 0 : doctor.companyEarn
        }, final withdraw ${
          doctor === null || doctor === void 0 ? void 0 : doctor.finalAmonut
        }`

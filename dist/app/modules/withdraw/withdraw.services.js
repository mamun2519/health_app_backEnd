...
const withdrawAccepted = (authUserId, id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield prisma_1.default.$transaction((transactionClient) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const message = `Accepted your withdraw request. withdraw balance ${doctor === null || doctor === void 0 ? void 0 : doctor.amount} BDT. 20% companyEarn ${doctor === null || doctor === void 0 ? void 0 : doctor.companyEarn}, final withdraw ${doctor === null || doctor === void 0 ? void 0 : doctor.finalAmonut}`;

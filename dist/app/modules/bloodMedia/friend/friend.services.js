...
const friendRequestIntoDB = (userId, data) => __awaiter(void 0, void 0, void 0, function* () {
...
const friendRequestCancelIntoDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
...
const friendRequestDeleteFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    return yield prisma_1.default.friendRequest.delete({
        where: { id: id },
    });
});
const friendRequestDetailsFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
...
const myAllFriendRequestFromDB = (userId) => __awaiter(void 0, void 0, void 0, function* () {
    const user = yield (0, utils_1.CheckUserByIdFromDB)(userId);
    if (!user) {
        throw new apiError_1.default(http_status_codes_1.StatusCodes.NOT_FOUND, 'User Not Found');
    }
...
// friend service
const acceptedFriendReqIntoDB = (data) => __awaiter(void 0, void 0, void 0, function* () {
    return yield prisma_1.default.myFriend.create({ data });
});
const acceptedFriendReqDeleteFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    return yield prisma_1.default.myFriend.delete({
        where: { id: id },
    });
});
const acceptedFriendReqDetailsFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
...
const myAllFriendFromDB = (userId) => __awaiter(void 0, void 0, void 0, function* () {
    const user = yield (0, utils_1.CheckUserByIdFromDB)(userId);
    if (!user) {
        throw new apiError_1.default(http_status_codes_1.StatusCodes.NOT_FOUND, 'User Not Found');
    }

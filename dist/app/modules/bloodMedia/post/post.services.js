...
const insertPostIntoDB = (user_id, post, avatar) => __awaiter(void 0, void 0, void 0, function* () {
...
const retrieveAllPostFromDB = () => __awaiter(void 0, void 0, void 0, function* () {
...
const updatePostByIdIntoDB = (post, avatar) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.$transaction((transactionClient) => __awaiter(void 0, void 0, void 0, function* () {
        var _a;
        ...
        if (avatar) {
            yield prisma_1.default.postAvatar.updateMany({
                where: {
                    postId: (_a = avatar[0]) === null || _a === void 0 ? void 0 : _a.postId,
                },
                data: avatar,
            });
        }
...
const deletePostByIdFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    return yield prisma_1.default.post.delete({ where: { id } });
});
const myAllPostFromDB = (userId) => __awaiter(void 0, void 0, void 0, function* () {

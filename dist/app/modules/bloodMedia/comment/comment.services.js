...
const insertCommentIntoDB = (userId, comment) =>
...
const updateCommentIntoDB = (commentId, comment) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const deleteCommentByIdFromDB = commentId =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getCommentByIdFromDB = commentId =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const myAllCommentFromDB = userId =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const insertReplyCommentIntoDB = (userId, replyComment) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const user = yield (0, utils_1.CheckUserByIdFromDB)(userId)
    if (!user) {
      throw new apiError_1.default(
...
const updateReplyCommentIntoDB = (replyCommentId, replyComment) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const deleteReplyCommentByIdFromDB = replyCommentId =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getReplyCommentByIdFromDB = replyCommentId =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const myAllReplyCommentFromDB = userId =>
  __awaiter(void 0, void 0, void 0, function* () {

...
const insetIntoDB = (authUserId, data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!doctor) {
        throw new apiError_1.default(http_status_codes_1.StatusCodes.BAD_REQUEST, 'doctor not found');
    }
    ...
    if (isActiveMeet) {
        throw new apiError_1.default(http_status_codes_1.StatusCodes.BAD_REQUEST, 'Yor Meet link already active.');
    }
...
const updateStatusAndDeleteGoogleMeet = (id) => __awaiter(void 0, void 0, void 0, function* () {
...
const getAllActiveMeetFromDB = (options) => __awaiter(void 0, void 0, void 0, function* () {

...
const insetIntoDB = (data, authUserId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield prisma_1.default.$transaction((transactionClient) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const message = `${(_a = user.profile) === null || _a === void 0 ? void 0 : _a.first_name} a appointment in your service. Appointment date ${data.bookingDate}`;
        ...
        yield transactionClient.notification.create({
            data: {
                userId: doctor === null || doctor === void 0 ? void 0 : doctor.user_id,
                message,
            },
        });
...
const getAllFromDB = (filter, options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const total = yield prisma_1.default.appointment.count({ where: whereCondition });
    return {
        meta: {
            total,
            limit,

...
router.patch(
  ...
  (0, validationRequest_1.default)(
    appointment_validiton_1.AppointmentValidation.update,
  ),
  appointment_controller_1.AppointmentController.updateByIdIntoDB,
)
router.delete(
  '/:id',
...
router.post(
  ...
  (0, validationRequest_1.default)(
    appointment_validiton_1.AppointmentValidation.create,
  ),
  appointment_controller_1.AppointmentController.insetIntoDB,
)

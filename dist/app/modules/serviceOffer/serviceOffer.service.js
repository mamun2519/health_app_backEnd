...
const insetIntoDB = (data, authUserId) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    console.log(data);
    ...
    data.doctorId = (_a = user.doctor) === null || _a === void 0 ? void 0 : _a.id;
    const allReadyOfferExist = yield prisma_1.default.serviceOffer.findFirst({
        where: {
    ...
    if (allReadyOfferExist) {
        throw new apiError_1.default(http_status_codes_1.StatusCodes.BAD_REQUEST, 'Already offer Active');
    }
    return yield prisma_1.default.serviceOffer.create({ data });
});
const getAllFromDB = (filets, options) => __awaiter(void 0, void 0, void 0, function* () {
    const { page, limit, skip } = (0, paginationHalper_1.calculatePagination)(options);
    const { searchTerm } = filets, filterData = __rest(filets, ["searchTerm"]);
    const andConditions = [];
    if (searchTerm) {
        andConditions.push({
            OR: serviceOffer_constant_1.ServiceOfferSearchAbleFiled.map(filed => ({
                [filed]: {
                    contains: searchTerm,
                    mode: 'insensitive',
                },
    ...
    const total = yield prisma_1.default.serviceOffer.count({ where: whereConditions });
    return {
        meta: {
            total,
            page,
...
const doctorOfferService = (authUserId, options) => __awaiter(void 0, void 0, void 0, function* () {
    var _b, _c;
    const { page, limit, skip } = (0, paginationHalper_1.calculatePagination)(options);
    const user = yield prisma_1.default.user.findFirst({
        where: {
    ...
    const result = yield prisma_1.default.serviceOffer.findMany({
        ...
        take: limit,
        where: {
            doctorId: (_b = user === null || user === void 0 ? void 0 : user.doctor) === null || _b === void 0 ? void 0 : _b.id,
        },
        include: {
            service: true,
        },
    ...
    const total = yield prisma_1.default.serviceOffer.count({
        where: {
            doctorId: (_c = user === null || user === void 0 ? void 0 : user.doctor) === null || _c === void 0 ? void 0 : _c.id,
        },
    });
    return {
        meta: {
...
const singleCartDelete = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.cart.delete({ where: { id } });
    return result;
});

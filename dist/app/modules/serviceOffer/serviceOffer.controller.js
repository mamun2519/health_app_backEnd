...
const insetIntoDB = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const user = req.user;
    const result = yield serviceOffer_service_1.ServiceOfferService.insetIntoDB(req.body, user.user_id);
...
const getAllFromDB = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const filter = (0, pick_1.receiveArrayAndReturnObject)(req.query, serviceOffer_constant_1.ServiceOfferFilterAbleFiled);
    const options = (0, pick_1.receiveArrayAndReturnObject)(req.query, pagination_1.paginationFiled);
    const result = yield serviceOffer_service_1.ServiceOfferService.getAllFromDB(filter, options);
    (0, APIResponse_1.default)(res, {
        success: true,
        statusCode: http_status_codes_1.StatusCodes.OK,
...
const getByIdFromDB = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield serviceOffer_service_1.ServiceOfferService.getByIdFromDB(req.params.id);
    (0, APIResponse_1.default)(res, {
        success: true,
        statusCode: http_status_codes_1.StatusCodes.OK,
...
const deleteByIdFromDB = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield serviceOffer_service_1.ServiceOfferService.deleteByIdFromDB(req.params.id);
    (0, APIResponse_1.default)(res, {
        success: true,
        statusCode: http_status_codes_1.StatusCodes.OK,
...
const updateByIdIntoDB = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield serviceOffer_service_1.ServiceOfferService.updateByIdIntoDB(req.params.id, req.body);
    (0, APIResponse_1.default)(res, {
        success: true,
        statusCode: http_status_codes_1.StatusCodes.OK,
...
const doctorOfferService = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const user = req.user;
    const options = (0, pick_1.receiveArrayAndReturnObject)(req.query, pagination_1.paginationFiled);
    const result = yield serviceOffer_service_1.ServiceOfferService.doctorOfferService(user.user_id, options);
    (0, APIResponse_1.default)(res, {
        success: true,
        statusCode: http_status_codes_1.StatusCodes.OK,
        message: 'Offer fetched success!',
...
const singleCartDelete = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // const options = receiveArrayAndReturnObject(req.query, paginationFiled)
    const result = yield serviceOffer_service_1.ServiceOfferService.singleCartDelete(req.params.id);
    (0, APIResponse_1.default)(res, {
        success: true,
        statusCode: http_status_codes_1.StatusCodes.OK,
        message: 'My Cart Fetch fetched success!',

...
const OrderAppointment = (appointment, payment, authUserId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (let i = 0; i < (appointment === null || appointment === void 0 ? void 0 : appointment.length); i++) {
        appointment.map((singleAppointment) => __awaiter(void 0, void 0, void 0, function* () {
            yield appointment_services_1.AppointmentService.insetIntoDB(singleAppointment, authUserId);
        }));
    }
    for (let i = 0; i < payment.length; i++) {
        payment.map((payment) => __awaiter(void 0, void 0, void 0, function* () {

...
const createPayment = (authUserId, data) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const newBalance =
      Number(doctor === null || doctor === void 0 ? void 0 : doctor.balance) +
      Number(data.price)
...
const createCompanyBalance = data =>
  __awaiter(void 0, void 0, void 0, function* () {
    return yield prisma_1.default.companyBalance.create({ data })
  })
const OrderAppointment = (appointment, payment, authUserId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const user = yield prisma_1.default.user.findFirst({
      where: { id: authUserId },
    })
    ...
    for (
      ...
      appointment.map(singleAppointment =>
        __awaiter(void 0, void 0, void 0, function* () {
          yield appointment_services_1.AppointmentService.insetIntoDB(
            singleAppointment,
            authUserId,
          )
        }),

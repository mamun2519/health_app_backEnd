...
route.post(
  ...
  (0, validationRequest_1.default)(
    medicine_validation_1.MedicineValidation.create,
  ),
  medicine_controller_1.MedicineController.insetIntoDB,
)
...
route.patch(
  ...
  medicine_controller_1.MedicineController.updateByIdIntoDB,
)
route.delete(
  '/:id',
  (0, auth_1.auth)(user_1.USER_ROLE.DOCTOR),
  medicine_controller_1.MedicineController.deleteByIdFromDB,
)

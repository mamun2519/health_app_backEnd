...
const insetIntoDB = (data, authUserId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!doctor) {
        throw new apiError_1.default(http_status_codes_1.StatusCodes.NOT_FOUND, 'User doctor found');
    }
...
const getAllFromDB = (filters, options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const total = yield prisma_1.default.prescription.count({ where: whereConditions });
    return {
        meta: {
            total,
            page,
...
const updateByIdIntoDB = (id, data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield prisma_1.default.medicine.update({
        where: { id: existMedicine === null || existMedicine === void 0 ? void 0 : existMedicine.id },
        data: medicine,
    });
    yield prisma_1.default.healtReport.update({
        where: { id: existHealtReport === null || existHealtReport === void 0 ? void 0 : existHealtReport.id },
        data: haltReport,
    });
...
const doctorAssignPrescription = (authUserId, options) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    ...
    if (!user) {
        throw new apiError_1.default(http_status_codes_1.StatusCodes.NOT_FOUND, 'Doctor Id Not Found');
    }
    const { page, limit, skip } = (0, paginationHalper_1.calculatePagination)(options);
    const result = yield prisma_1.default.prescription.findMany({
        skip,
        take: limit,
        where: {
            doctorId: (_a = user === null || user === void 0 ? void 0 : user.doctor) === null || _a === void 0 ? void 0 : _a.id,
        },

...
const insetIntoDB = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const user = req.user
    const result =
      yield prescription_services_1.PrescriptionService.insetIntoDB(
        req.body,
        user.user_id,
      )
...
const doctorAssignPrescription = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const user = req.user
    ...
    const result =
      yield prescription_services_1.PrescriptionService.doctorAssignPrescription(
        user.user_id,
        options,
      )
    ;(0, APIResponse_1.default)(res, {
...
const getAllFromDB = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const filter = (0, pick_1.receiveArrayAndReturnObject)(
      req.query,
      serviceOffer_constant_1.PrescriptionFilterAbleFiled,
    )
    const options = (0, pick_1.receiveArrayAndReturnObject)(
      req.query,
      pagination_1.paginationFiled,
    ...
    const result =
      yield prescription_services_1.PrescriptionService.getAllFromDB(
        filter,
        options,
      )
    ;(0, APIResponse_1.default)(res, {
...
const getByIdFromDB = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result =
      yield prescription_services_1.PrescriptionService.getByIdFromDB(
        req.params.id,
      )
    ;(0, APIResponse_1.default)(res, {
      success: true,
...
const updateByIdIntoDB = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result =
      yield prescription_services_1.PrescriptionService.updateByIdIntoDB(
        req.params.id,
        req.body,
      )
    ;(0, APIResponse_1.default)(res, {
...
const deleteByIdFromDB = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result =
      yield prescription_services_1.PrescriptionService.deleteByIdFromDB(
        req.params.id,
      )
    ;(0, APIResponse_1.default)(res, {
      success: true,

...
const updateByIdIntoDB = (authUserId, payload) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    ...
    if (payload && (payload === null || payload === void 0 ? void 0 : payload.presentAddress)) {
        yield prisma_1.default.presentAddress.update({
            where: {
                profile_Id: (_a = user === null || user === void 0 ? void 0 : user.profile) === null || _a === void 0 ? void 0 : _a.id,
            },
            data: payload.presentAddress,
        });
    }
    if (payload && (payload === null || payload === void 0 ? void 0 : payload.permanentAddress)) {
        yield prisma_1.default.permanentAddress.update({
            where: {
                profile_Id: (_b = user === null || user === void 0 ? void 0 : user.profile) === null || _b === void 0 ? void 0 : _b.id,
            },
...
const bloodDonorRequest = (authUserId, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const user = yield prisma_1.default.user.findFirst({
        where: { id: authUserId },
        include: {
            profile: true,
    ...
    const result = yield prisma_1.default.$transaction((transactionClient) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const message = `${(_c = user.profile) === null || _c === void 0 ? void 0 : _c.user_name} donor request to you. his need ${payload.quantity} beg blood and donned date ${payload.donnetDate}.`;
...
const myDonorRequest = (authUserId, pagination) => __awaiter(void 0, void 0, void 0, function* () {
    const { limit, skip, page } = (0, paginationHalper_1.calculatePagination)(pagination);
...
const myDonorReviewFromDB = (authUserId, pagination) => __awaiter(void 0, void 0, void 0, function* () {
    const { limit, skip, page } = (0, paginationHalper_1.calculatePagination)(pagination);
...
const myAppointment = (authUserId, options) => __awaiter(void 0, void 0, void 0, function* () {
    const { limit, skip, page } = (0, paginationHalper_1.calculatePagination)(options);
...
const filtersDoctorFromDB = (filters, pagination) => __awaiter(void 0, void 0, void 0, function* () {
...
const AllUserFromDb = (options) => __awaiter(void 0, void 0, void 0, function* () {
    const { limit, skip } = (0, paginationHalper_1.calculatePagination)(options);
    const result = yield prisma_1.default.user.findMany({
        skip,
        take: limit,
        where: {
...
const AllAdminFromDB = (options) => __awaiter(void 0, void 0, void 0, function* () {
    console.log(options);
    const { limit, skip } = (0, paginationHalper_1.calculatePagination)(options);
    const result = yield prisma_1.default.user.findMany({
        skip,
...
const myNotification = (authUserId) => __awaiter(void 0, void 0, void 0, function* () {
...
const updateUserProfile = (authUserId, data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield prisma_1.default.$transaction((transactionClient) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const profiles = yield transactionClient.profile.update({
            ...
            data: {
                ...
                cover: profile === null || profile === void 0 ? void 0 : profile.cover,
        ...
        const allreadyExist = yield prisma_1.default.presentAddress.findFirst({
            where: {
                profile_Id: (_d = user.profile) === null || _d === void 0 ? void 0 : _d.id,
            },
        });
        if (!allreadyExist) {
            if (user.profile && address) {
                yield transactionClient.presentAddress.create({
                    data: {
                        profile_Id: (_e = user === null || user === void 0 ? void 0 : user.profile) === null || _e === void 0 ? void 0 : _e.id,
            ...
            if ((user === null || user === void 0 ? void 0 : user.profile) && address) {
                yield transactionClient.presentAddress.update({
                    where: { profile_Id: user.profile.id },
                    data: {
                        address: address === null || address === void 0 ? void 0 : address.address,
                        sub_district: address === null || address === void 0 ? void 0 : address.sub_district,

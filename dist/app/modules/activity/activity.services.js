...
const donorActivity = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return {
        ...
        schedule,
        pendingRequest,
        name: `${(_p = user.profile) === null || _p === void 0 ? void 0 : _p.first_name}  ${(_q = user.profile) === null || _q === void 0 ? void 0 : _q.last_name} `,
    };
});
const doctorActivity = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const appointment = yield prisma_1.default.appointment.count({
        where: {
            doctorId: (_r = user === null || user === void 0 ? void 0 : user.doctor) === null || _r === void 0 ? void 0 : _r.id,
        },
    });
    ...
    return {
        ...
        service,
        balance: Number((_u = user === null || user === void 0 ? void 0 : user.doctor) === null || _u === void 0 ? void 0 : _u.balance),
        patient: Number((_v = user === null || user === void 0 ? void 0 : user.doctor) === null || _v === void 0 ? void 0 : _v.total_patient),
        completeDonation,
        donorRequest,
        pendingWithdraw,
        name: `${(_w = user.profile) === null || _w === void 0 ? void 0 : _w.first_name}  ${(_x = user.profile) === null || _x === void 0 ? void 0 : _x.last_name} `,
    };
});
const adminActivity = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return {
        ...
        doctor,
        bloodDonor,
        name: `${(_y = user.profile) === null || _y === void 0 ? void 0 : _y.first_name}  ${(_z = user.profile) === null || _z === void 0 ? void 0 : _z.last_name} `,
    };
});

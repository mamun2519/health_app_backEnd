...
exports.MyDonarRequest = exports.MyCompleteBloodDonation = exports.DoctorResentWithdraw = exports.DoctorTop5ServicePrice = exports.FinalTop5Donar = exports.FinalTop5Service = void 0;
/* eslint-disable @typescript-eslint/no-explicit-any */
/* eslint-disable no-unused-vars */
const prisma_1 = __importDefault(require("../../../prisma/prisma"));
const FinalTop5Service = () => __awaiter(void 0, void 0, void 0, function* () {
...
const FinalTop5Donar = () => __awaiter(void 0, void 0, void 0, function* () {
...
const DoctorTop5ServicePrice = (doctorId) => __awaiter(void 0, void 0, void 0, function* () {
    const sales = yield prisma_1.default.payment.findMany({
        where: {
            doctorId,
        },
...
const DoctorResentWithdraw = (doctorId) => __awaiter(void 0, void 0, void 0, function* () {
...
const MyCompleteBloodDonation = (donorId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const finalDonation = donor
        ...
        var _a, _b;
        return {
            requestUserName: `${(_a = donation.user.profile) === null || _a === void 0 ? void 0 : _a.first_name} ${(_b = donation.user.profile) === null || _b === void 0 ? void 0 : _b.last_name}`,
            // date: donation.c
...
const MyDonarRequest = (userId) => __awaiter(void 0, void 0, void 0, function* () {
    const donor = yield prisma_1.default.donorRequest.findMany({
        where: {
            userId,
        },
    ...
    const finalDonation = donor
        ...
        var _a, _b;
        return {
            donarName: `${(_a = donation.donor.user.profile) === null || _a === void 0 ? void 0 : _a.first_name} ${(_b = donation.donor.user.profile) === null || _b === void 0 ? void 0 : _b.last_name}`,
            // date: donation.c
            total: donation.quantity,

...
route.post(
  ...
  (0, validationRequest_1.default)(
    haltReport_validation_1.HaltReportValidation.create,
  ),
  haltReport_controller_1.HaltReportController.insetIntoDB,
)
...
route.patch(
  ...
  (0, auth_1.auth)(user_1.USER_ROLE.DOCTOR),
  (0, validationRequest_1.default)(
    haltReport_validation_1.HaltReportValidation.update,
  ),
  haltReport_controller_1.HaltReportController.updateByIdIntoDB,
)
route.delete(
  '/:id',
  (0, auth_1.auth)(user_1.USER_ROLE.DOCTOR),
  haltReport_controller_1.HaltReportController.deleteByIdFromDB,
)

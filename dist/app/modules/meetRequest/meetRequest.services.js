...
const createMeetingRequestIntoDB = (authUserId, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if ((appointment === null || appointment === void 0 ? void 0 : appointment.serialNo) == payload.serialNo) {
...
const doctorMeetingRequest = (authUserId, options) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;

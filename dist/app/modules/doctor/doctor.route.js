...
router.get(
  ...
  doctor_controller_1.DoctorController.myPaymentList,
)
router.get(
  '/my-prescription',
  (0, auth_1.auth)(user_1.USER_ROLE.DOCTOR),
  doctor_controller_1.DoctorController.myPrescription,
)
router.get(
  '/my-all-meet',
  (0, auth_1.auth)(user_1.USER_ROLE.DOCTOR),
  doctor_controller_1.DoctorController.myGoogleMeet,
)
router.get(
  '/filter-services',
  doctor_controller_1.DoctorController.getFilterServiceFromDB,
)
...
router.post(
  ...
  (0, validationRequest_1.default)(
    doctor_validation_1.DoctorServiceValidation.create,
  ),
  doctor_controller_1.DoctorController.createServiceIntoDB,
)
router.get(
  '/my-complete-meet',
  (0, auth_1.auth)(user_1.USER_ROLE.DOCTOR),
  doctor_controller_1.DoctorController.myCompletedGoogleMeetService,
)
router.get(
  '/my-service',
  (0, auth_1.auth)(user_1.USER_ROLE.DOCTOR),
  doctor_controller_1.DoctorController.myServiceFromDB,
)
router.get(
  '/my-booking-appointment',
  (0, auth_1.auth)(user_1.USER_ROLE.DOCTOR),
  doctor_controller_1.DoctorController.myBookingAppointment,
)
router.get(
  '/my-active-meet',
  (0, auth_1.auth)(user_1.USER_ROLE.DOCTOR),
  doctor_controller_1.DoctorController.myActiveGoogleMeetService,
)
router.get(
  '/my-withdraw',
  (0, auth_1.auth)(user_1.USER_ROLE.DOCTOR),
  doctor_controller_1.DoctorController.myWithdrawList,
)

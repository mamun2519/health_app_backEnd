...
const getAllFromDB = (filters, options) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield server_1.client.set('doctor-services', JSON.stringify(result), {
      EX: 60,
    })
...
const allDoctorFromDB = (options, filter) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { page, limit, skip } = (0, paginationHalper_1.calculatePagination)(
      options,
    )
    ...
    if (filter) {
      result = result.filter(doctor => {
        var _a
        return (
          ((_a = doctor.doctor) === null || _a === void 0
            ? void 0
            : _a.specialist) === filter
        )
      })
    }
    return {

...
router.post('/forget-request', auth_controller_1.AuthController.requestForgetPassword);
router.post('/check-reset-code', auth_controller_1.AuthController.CheckValidationResetCode);
router.post('/forget-code', auth_controller_1.AuthController.forgetPasswordWithCode);
